...
//Code attributed to... http://www.wpexplorer.com/wordpress-page-templates-plugin/ ... thanks!

//This class adds Sgp Page templates (views) to the installed Wordpress theme
class PageTemplater {
	...
	//Methods
		...
		private function __construct() {
			...
			$this->templates = array(
				'outcome-overview.php' => 'SGP - Outcome Overview',
				'single-resource.php' => 'SGP - Resource Page',
				'single-spiritual_outcomes' => 'SGP - Spiritual Outcome Page',
				'update-core-resources.php' => 'SGP - Update Core',
