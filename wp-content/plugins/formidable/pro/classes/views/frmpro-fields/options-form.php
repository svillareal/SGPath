...
<?php }else if($field['type'] == 'number' and $frm_settings->use_html){ ?>
    <tr><td style="width:150px"><label><?php _e('Number Range', 'formidable') ?> <span class="frm_help frm_icon_font frm_tooltip_icon" title="<?php _e('Browsers that support the HTML5 number field require a number range to determine the numbers seen when clicking the arrows next to the field.', 'formidable') ?>" ></span></label></td>
