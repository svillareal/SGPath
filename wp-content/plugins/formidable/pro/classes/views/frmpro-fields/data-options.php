...
<select <?php echo $disabled ?> name="<?php echo $field_name ?>" id="<?php echo $html_id ?>" <?php do_action('frm_field_input_html', $field) ?>>
<?php
        if ($field['options']){
...
<input name="<?php echo $field_name ?>" id="<?php echo $html_id ?>" type="hidden" value="<?php echo esc_attr($v) ?>" />
<?php
                unset($v);
            }
        }else{ ?>
<input name="<?php echo $field_name ?>" id="<?php echo $html_id ?>" type="hidden" value="<?php echo esc_attr($field['value']) ?>" />
<?php   }
    }
...
<div class="<?php echo apply_filters('frm_checkbox_class', 'frm_checkbox', $field, $opt_key)?>"><label for="<?php echo $html_id ?>-<?php echo $opt_key ?>"><input type="checkbox" name="<?php echo $field_name ?>[]"  id="<?php echo $html_id ?>-<?php echo $opt_key ?>" value="<?php echo $opt_key ?>" <?php echo $checked . $disabled?> <?php do_action('frm_field_input_html', $field) ?> /> <?php echo $opt ?></label></div>
<?php   }
...
<div class="<?php echo apply_filters('frm_radio_class', 'frm_radio', $field, $opt_key) ?>"><label for="<?php echo $html_id ?>-<?php echo $opt_key ?>"><input type="radio" name="<?php echo $field_name ?>" id="<?php echo $html_id ?>-<?php echo $opt_key ?>" value="<?php echo $opt_key ?>" <?php echo $checked . $disabled; ?> <?php do_action('frm_field_input_html', $field) ?> /> <?php echo $opt ?></label></div>
        <?php }
    }//else echo 'There are no options'; ?>
<?php }