<h3><?php _e('Permissions', 'formidable') ?> <span class="frm_help frm_icon_font frm_tooltip_icon" title="<?php _e('Determine who can see, submit, and edit form entries.', 'formidable') ?>" ></span></h3>
