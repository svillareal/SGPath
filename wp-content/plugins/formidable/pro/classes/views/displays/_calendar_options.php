...
<select id="date_field_id" name="options[date_field_id]">
    ...
    if ( is_numeric($post->frm_form_id) && !empty($post->frm_form_id) ) {
        FrmProFieldsHelper::get_field_options($post->frm_form_id, $post->frm_date_field_id, '', "'date'");
    } ?>
</select>
<br/>
...
<select id="edate_field_id" name="options[edate_field_id]">
    ...
    <?php
    if ( is_numeric($post->frm_form_id) && !empty($post->frm_form_id) ) {
        FrmProFieldsHelper::get_field_options($post->frm_form_id, $post->frm_edate_field_id, '', "'date', 'number', 'select', 'radio', 'scale'");
    } ?>
</select>
<br/>
...
<select id="repeat_edate_field_id" name="options[repeat_edate_field_id]">
    ...
    <?php
    if ( is_numeric($post->frm_form_id) && !empty($post->frm_form_id) ) {
        FrmProFieldsHelper::get_field_options($post->frm_form_id, $post->frm_repeat_edate_field_id, '', "'date'");
    } ?>
</select>