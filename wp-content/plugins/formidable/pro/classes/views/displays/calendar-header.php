...
?></select> <select class="frmcal-dropdown" onchange="window.location='<?php echo remove_query_arg('frmcal-year', add_query_arg(array('frmcal-month' => $month))) ?>&amp;frmcal-year='+this.value+'#frmcal-<?php echo esc_attr( $display->ID ) ?>';"><?php
