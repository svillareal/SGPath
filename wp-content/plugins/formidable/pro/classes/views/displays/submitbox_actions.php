<div class="misc-pub-section">
    ...
    <div id="frm_shortcodediv" class="hide-if-js">
    	...
    	<input type="text" style="width:98%;margin-top:4px;" readonly="true" class="frm_select_box" value='[display-frm-data id=<?php echo ( isset( $post->post_name ) && $post->post_name != '' ) ? $post->post_name : '??'; ?> filter=1]' />
    	<?php } ?>
    	</p>
