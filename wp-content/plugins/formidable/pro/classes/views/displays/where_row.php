<div id="frm_where_field_<?php echo $where_key; ?>" class="frm_where_row">
    <select id="where_field_id" class="frm_insert_where_options" name="options[where][<?php echo $where_key; ?>]">
        ...
        if ( is_numeric($form_id) ) {
            FrmProFieldsHelper::get_field_options($form_id, $where_field, 'not', "'break','end_divider','divider','file'");
        } ?>
    </select>
    ...
    <a href="javascript:void(0)" class="frm_remove_tag frm_icon_font" data-removeid="frm_where_field_<?php echo $where_key; ?>" data-showlast="#frm_where_options .frm_add_where_row"></a>
