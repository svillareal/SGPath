<div id="frm_order_field_<?php echo $order_key; ?>" class="frm_order_row">
	<select id="order_by" name="options[order_by][<?php echo $order_key; ?>]">
    ...
    <select id="order" name="options[order][<?php echo $order_key; ?>]">
		...
		<a href="javascript:void(0)" class="frm_remove_tag frm_icon_font" data-removeid="frm_order_field_<?php echo $order_key; ?>" data-showlast="#frm_order_options .frm_add_order_row"></a>
