...
<div class="wrap">
    <h2 class="nav-tab-wrapper">
    	<a href="#frm_content_box" class="nav-tab nav-tab-active"><?php _e('Listing Page', 'formidable') ?></a>
    ...
    <p class="nav-menu-content frm_content_box"><?php _e('This page lists multiple entries. Link to a single entry/detail page using [detaillink]', 'formidable'); ?></p>
...
<p style="float:right;margin:0;"><label for="options_no_rt"> <input type="checkbox" id="options_no_rt" name="options[no_rt]" value="1" <?php checked($post->frm_no_rt, 1) ?> /> <?php _e('Disable visual editor for this view', 'formidable') ?></label> <span class="frm_help frm_icon_font frm_tooltip_icon" title="<?php _e('It is recommended to check this box if you include a &lt;table&gt; tag in the Before Content box.', 'formidable') ?>" ></span></p>
<div class="clear"></div>
...
<div class="nav-menu-content hide-if-js" id="frm_dyncontent_box">
    <div class="hide_dyncontent <?php echo $hide_dyn; ?>">
