<div id="postbox-container-1" class="postbox-container">
    ...
    <div class="inside">
        ...
        <div id="major-publishing-actions">
    	    ...
    	    <a href="?page=formidable-entries&amp;frm_action=destroy&amp;id=<?php echo $record->id; ?>&amp;form=<?php echo $form->id ?>" class="submitdelete deletion" onclick="return confirm('<?php _e('Are you sure you want to delete this entry?', 'formidable') ?>');" title="<?php _e('Delete') ?>"><?php _e('Delete') ?></a>
    	    <?php if(!empty($record->post_id)){ ?>
    	    <a href="?page=formidable-entries&amp;frm_action=destroy&amp;id=<?php echo $record->id; ?>&amp;form=<?php echo $form->id ?>&amp;keep_post=1" class="submitdelete deletion" style="margin-left:10px;" onclick="return confirm('<?php _e('Are you sure you want to delete this entry?', 'formidable') ?>');" title="<?php _e('Delete entry but leave the post', 'formidable') ?>"><?php _e('Delete without Post', 'formidable') ?></a>
    	    <?php } ?>
    	    </div>
    	    <?php } ?>
