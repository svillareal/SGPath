...
?><input type="search" name="frm_search" id="frm_search" class="s" value="<?php echo esc_attr( FrmAppHelper::get_param('frm_search') ); ?>" /><input type="submit" value="<?php echo esc_attr( $atts['label'] ) ?>" class="searchsubmit" /></form><?php
if ( ! empty($atts['style']) ) {
?></div><?php
}